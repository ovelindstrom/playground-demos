package com.example.demo.jokes.eclipsestore.controller;

import org.springframework.web.bind.annotation.*;

import com.example.demo.jokes.eclipsestore.service.JokesServices;
 ...
 */
@RestController
@RequestMapping({"/api/jokes", "/api/jokes/"})
public class JokesController
{
    ...
    /** 
     * Searches for jokes containing a specific keyword.
    */
    @GetMapping("/search")
    public List<String> search(@RequestParam(name = "keyword") String keyword)
    {
        return jokesServices.searchJokes(keyword);
    }
